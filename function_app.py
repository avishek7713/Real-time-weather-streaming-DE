...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAME = "weatherstreaminingeventhub"

    EVENT_HUB_NAMESPACE = "weatherstreaming-ns.servicebus.windows.net"
    ...
    def flatten_data(current_weather, forecast_weather, alerts):
        ...
        flatten_data = {
            ...
            'feel_like_c': current.get("feelslike_c"),
            'uv': current.get("uv"),
            'air_quality': {
    ...
    def fetch_weather_data():
        ...
        # Fetch the API key from the key vault
        VAULT_URL = "https://kv-weather-streaming-ave.vault.azure.net/"
